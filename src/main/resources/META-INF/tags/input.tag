<%@tag
	description="Generates a Bootstrap styled text/password input control with automatic Spring error binding."
	pageEncoding="UTF-8"%>
...
<%@attribute name="cssClass" required="false" type="java.lang.String"
	description="The Bootstrap css class to apply to this control e.g. input-sm, input-lg etc. Defaults to input-md if not specified."%>
...
<%@attribute name="prependText" required="false" type="java.lang.String"
	description="The string which should be affixed to the front of the control."%>

<%@attribute name="appendText" required="false" type="java.lang.String"
	description="The characters which should be affixed to the rear of the control."%>
